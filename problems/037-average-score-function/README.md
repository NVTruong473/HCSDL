...
Create a function returning one student's average recorded score.
...
See [`sql/03_btl/functions.sql`](../../sql/03_btl/functions.sql) and find the section marked `P037` (or the corresponding documented section for design/theory problems).
