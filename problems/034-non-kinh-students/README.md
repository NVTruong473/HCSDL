# P034 — Non-Kinh students

**Difficulty:** Easy  
**Track:** Legacy coursework: academic-management BTL  
**Topics:** JOIN, inequality

## Problem

List students whose ethnicity is not Kinh.
...
See [`sql/03_btl/queries.sql`](../../sql/03_btl/queries.sql) and find the section marked `P034` (or the corresponding documented section for design/theory problems).
