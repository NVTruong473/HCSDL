...
Traverse course prerequisites recursively.
...
See [`sql/04_advanced/advanced_challenges.sql`](../../sql/04_advanced/advanced_challenges.sql) and find the section marked `P080` (or the corresponding documented section for design/theory problems).
