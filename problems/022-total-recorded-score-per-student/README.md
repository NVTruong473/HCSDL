# P022 — Total recorded score per student
...
Sum all recorded attempt scores per student as the literal original exercise requests.
...
See [`sql/03_btl/queries.sql`](../../sql/03_btl/queries.sql) and find the section marked `P022` (or the corresponding documented section for design/theory problems).
